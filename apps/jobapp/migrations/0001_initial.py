...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DailyJob'
        db.create_table('jobapp_dailyjob', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('text', self.gf('django.db.models.fields.TextField')(max_length=1000)),
            ('n', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('is_on', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('importance', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('jobapp', ['DailyJob'])

        # Adding model 'DailyJobTick'
        db.create_table('jobapp_dailyjobtick', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jobapp.DailyJob'])),
            ('done', self.gf('django.db.models.fields.IntegerField')()),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('jobapp', ['DailyJobTick'])

        # Adding model 'JobGroup'
        db.create_table('jobapp_jobgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('text', self.gf('django.db.models.fields.TextField')(max_length=2000)),
            ('is_public', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('jobapp', ['JobGroup'])

        # Adding model 'Job'
        db.create_table('jobapp_job', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jobapp.JobGroup'], null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('text', self.gf('django.db.models.fields.TextField')(max_length=1000)),
            ('n', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('is_on', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('is_done', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('importance', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('deadline', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('jobapp', ['Job'])


    def backwards(self, orm):
        
        # Deleting model 'DailyJob'
        db.delete_table('jobapp_dailyjob')

        # Deleting model 'DailyJobTick'
        db.delete_table('jobapp_dailyjobtick')

        # Deleting model 'JobGroup'
        db.delete_table('jobapp_jobgroup')

        # Deleting model 'Job'
        db.delete_table('jobapp_job')
