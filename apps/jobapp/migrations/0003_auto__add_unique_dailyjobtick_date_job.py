...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'DailyJobTick', fields ['date', 'job']
        db.create_unique('jobapp_dailyjobtick', ['date', 'job_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'DailyJobTick', fields ['date', 'job']
        db.delete_unique('jobapp_dailyjobtick', ['date', 'job_id'])
    ...
    models = {
        ...
        'jobapp.dailyjobtick': {
            'Meta': {'unique_together': "(('job', 'date'),)", 'object_name': 'DailyJobTick'},
