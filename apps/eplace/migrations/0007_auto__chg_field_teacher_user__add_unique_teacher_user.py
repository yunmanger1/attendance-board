...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Teacher.user'
        db.alter_column('eplace_teacher', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

        # Adding unique constraint on 'Teacher', fields ['user']
        db.create_unique('eplace_teacher', ['user_id'])


    def backwards(self, orm):
        
        # Changing field 'Teacher.user'
        db.alter_column('eplace_teacher', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Removing unique constraint on 'Teacher', fields ['user']
        db.delete_unique('eplace_teacher', ['user_id'])
