...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CopyPasteStudents'
        db.create_table('eplace_copypastestudents', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eplace.Group'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('eplace', ['CopyPasteStudents'])


    def backwards(self, orm):
        
        # Deleting model 'CopyPasteStudents'
        db.delete_table('eplace_copypastestudents')
