...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tick.student'
        db.add_column('eplace_tick', 'student', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['eplace.Student']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tick.student'
        db.delete_column('eplace_tick', 'student_id')
