...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tick.pub_date'
        db.add_column('eplace_tick', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2010, 8, 24), blank=True), keep_default=False)

        # Adding unique constraint on 'LessonDay', fields ['date', 'group', 'teacher', 'subject']
        db.create_unique('eplace_lessonday', ['date', 'group_id', 'teacher_id', 'subject_id'])


    def backwards(self, orm):
        
        # Deleting field 'Tick.pub_date'
        db.delete_column('eplace_tick', 'pub_date')

        # Removing unique constraint on 'LessonDay', fields ['date', 'group', 'teacher', 'subject']
        db.delete_unique('eplace_lessonday', ['date', 'group_id', 'teacher_id', 'subject_id'])
    ...
    models = {
        ...
        'eplace.lessonday': {
            'Meta': {'unique_together': "(('date', 'group', 'subject', 'teacher'),)", 'object_name': 'LessonDay'},
